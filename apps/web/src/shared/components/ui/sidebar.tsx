...
function SidebarProvider({
  ...
  // Always call useState, but only access document in the initializer if on client
...
function SidebarTrigger({
  ...
  // The trigger button is not rendered on desktop by default.
  // Instead, a keyboard shortcut is used to toggle the sidebar.
  // The trigger is part of the `SidebarRail` component.
  return (
    <Button
      variant="ghost"
      size="icon"
