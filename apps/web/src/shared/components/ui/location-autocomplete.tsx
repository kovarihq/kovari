    ...
    <div ref={wrapperRef} className={cn("relative w-full", className)}>
      <div className="relative">
        <Input
          ...
          disabled={disabled}
          className="pr-10 bg-transparent border-border text-foreground rounded-lg" 
          autoComplete="off"
        />
        {isLoading && (
      ...
      {isOpen && suggestions.length > 0 && (
        <div className="absolute z-50 mt-1 max-h-60 w-full overflow-auto hide-scrollbar rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95">
